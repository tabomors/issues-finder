...
/** Metadata for an audit entry with action business.* */
export type BusinessAuditEntryData = {
  /** The HTTP path for this business */
  businessResourcePath?: Maybe<Scalars["URI"]>;
  /** The slug of the business. */
  businessSlug?: Maybe<Scalars["String"]>;
  /** The HTTP URL for this business */
  businessUrl?: Maybe<Scalars["URI"]>;
};
...
export type PushAllowanceActor = Team | User;
...
> & {
    ...
    labels: Maybe<
      ...
      > & {
          nodes: Maybe<
            Array<Maybe<{ __typename?: "Label" } & Pick<Label, "name">>>
          >;
        }
    >;
  };
      ...
      Array<
        Maybe<
          { __typename?: "SearchResultItemEdge" } & Pick<
            ...
            "cursor"
          > & { node: Maybe<IssueContentFragment> }
        >
      >
    >;
  };
...
`;
export type FindIssuesComponentProps = Omit<
  ReactApollo.QueryProps<FindIssuesQuery, FindIssuesQueryVariables>,
  "query"
> &
  ({ variables: FindIssuesQueryVariables; skip?: false } | { skip: true });

export const FindIssuesComponent = (props: FindIssuesComponentProps) => (
  <ReactApollo.Query<FindIssuesQuery, FindIssuesQueryVariables>
    query={FindIssuesDocument}
    {...props}
  />
);

export type FindIssuesProps<TChildProps = {}> = Partial<
  ReactApollo.DataProps<FindIssuesQuery, FindIssuesQueryVariables>
> &
  TChildProps;
export function withFindIssues<TProps, TChildProps = {}>(
  operationOptions?: ReactApollo.OperationOption<
    TProps,
    FindIssuesQuery,
    FindIssuesQueryVariables,
    FindIssuesProps<TChildProps>
  >
) {
