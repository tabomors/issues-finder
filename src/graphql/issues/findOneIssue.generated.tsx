...
export const useFindOneIssueQuery = <
      TData = FindOneIssueQuery,
      TError = unknown
    >(
      variables: FindOneIssueQueryVariables,
      options?: UseQueryOptions<FindOneIssueQuery, TError, TData>
    ) =>
    useQuery<FindOneIssueQuery, TError, TData>(
      ['findOneIssue', variables],
      fetcher<FindOneIssueQuery, FindOneIssueQueryVariables>(FindOneIssueDocument, variables),
      options
    );
export const useInfiniteFindOneIssueQuery = <
      TData = FindOneIssueQuery,
      TError = unknown
    >(
      pageParamKey: keyof FindOneIssueQueryVariables,
      variables: FindOneIssueQueryVariables,
      options?: UseInfiniteQueryOptions<FindOneIssueQuery, TError, TData>
    ) =>
    useInfiniteQuery<FindOneIssueQuery, TError, TData>(
      ['findOneIssue.infinite', variables],
      (metaData) => fetcher<FindOneIssueQuery, FindOneIssueQueryVariables>(FindOneIssueDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      options
    );
