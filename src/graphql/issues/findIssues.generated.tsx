...
export const useFindIssuesQuery = <TData = FindIssuesQuery, TError = unknown>(
  ...
  useQuery<FindIssuesQuery, TError, TData>(
    ...
    fetcher<FindIssuesQuery, FindIssuesQueryVariables>(
      FindIssuesDocument,
      variables,
    ),
    options,
...
>(
  ...
  useInfiniteQuery<FindIssuesQuery, TError, TData>(
    ...
    (metaData) =>
      fetcher<FindIssuesQuery, FindIssuesQueryVariables>(FindIssuesDocument, {
        ...variables,
        ...(metaData.pageParam ?? {}),
      })(),
    options,
